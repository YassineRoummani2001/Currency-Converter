...
for (let i = 0; i < dropList.length; i++) {
    for(let currency_code in country_list){
        ...
        let selected = i == 0 ? currency_code == "USD" ? "selected" : "" : currency_code == "MAD" ? "selected" : "";
...
function getExchangeRate(){
    ...
    let url = `https://v6.exchangerate-api.com/v6/aa5a970f43f9a204479d921a/latest/${fromCurrency.value}`;
